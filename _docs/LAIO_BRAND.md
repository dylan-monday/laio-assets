# LAIO_BRAND.md
## LA.IO Brand System Reference — Lovable Projects

> This document is authoritative context for every LA.IO project built in Lovable.
...
`laio-fonts-inline.css` lives at `https://assets.la.io/fonts/laio-fonts-inline.css`. In a Lovable project it is only needed when the preview cannot reach assets.la.io.
