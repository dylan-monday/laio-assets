...
Design systems are account-bound, so each person who designs LA.IO work creates their own. It takes a couple of minutes. Claude Design reads the brand straight from the LA.IO repo on GitHub: the skill, the fonts, the logos, the motifs, and the color tokens.

Verified 2026-09-11: this setup renders Aktiv Grotesk.
